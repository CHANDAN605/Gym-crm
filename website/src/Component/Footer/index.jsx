                                    ...
                                    <div className="flickr-list">
                                        <ul>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr1.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr1"
                                                >
                                                    <img src="img/flickr/flickr1.png" alt="flickr1" />
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr2.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr2"
                                                >
                                                    <img src="img/flickr/flickr2.png" alt="flickr2" />
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr3.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr3"
                                                >
                                                    <img src="img/flickr/flickr3.png" alt="flickr3" />
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr4.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr4"
                                                >
                                                    <img src="img/flickr/flickr4.png" alt="flickr4" />
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr5.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr5"
                                                >
                                                    <img src="img/flickr/flickr5.png" alt="flickr5" />
                                                </a>
                                            </li>
                                            <li>
                                                <a
                                                    className="fancybox"
                                                    href="img/flickr/flickr6.png"
                                                    data-fancybox-group="flickr"
                                                    title="flickr6"
                                                >
                                                    <img src="img/flickr/flickr6.png" alt="flickr6" />
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-9 col-md-9 col-sm-9">
                                <div className="copy-right">
                                    <p>
                                        © Copyrights gymedge 2016. All rights reserved. Designed by
                                        <a
                                            target="_blank"
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-3">
                                <div className="visa-card">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="img/descover.png" alt="descover" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
